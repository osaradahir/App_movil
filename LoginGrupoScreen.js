...
const LoginGrupoScreen = ({  }) => {
  ...
  const handleLogin = async () => {
    try {
      const response = await fetch('https://d9hpth2q-3000.usw3.devtunnels.ms/grupo-login', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        navigation.navigate('HorarioGrupoScreen');
      } else {
...
export default LoginGrupoScreen;
